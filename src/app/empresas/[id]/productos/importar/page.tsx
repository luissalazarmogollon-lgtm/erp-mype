  ...
  return (
    <main style={{ maxWidth: 700, margin: "0 auto", padding: "32px 24px" }}>
      ...
      <p style={{ fontSize: 13, color: "var(--ink-soft)", marginBottom: 20 }}>
        ...
        categoría que todavía no existe, se crea automáticamente. Si una fila coincide con un producto que ya tienes
        registrado (mismo código, o si no pones código, mismo nombre), se <strong>sobrescriben todos sus datos</strong>{" "}
        (nombre, código, categoría, tipo, precio de venta y si requiere receta) con lo que traiga la plantilla.
      </p>
      <p style={{ fontSize: 13, color: "var(--ink-soft)", marginBottom: 20 }}>
        La receta (hoja "Receta") tiene su propia regla: si un producto <strong>no aparece</strong> en esa hoja, su
        receta actual no se toca; si <strong>sí aparece</strong>, su receta se reemplaza por completo con las líneas
        de esa hoja. A diferencia de la categoría, un insumo que escribas ahí y no exista en esta empresa{" "}
        <strong>no se crea solo</strong> — la fila queda marcada como error para que corrijas el nombre.
      </p>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        ...
        <p className="mono" style={{ fontSize: 11, color: "var(--ink-soft)", marginTop: 8 }}>
          Trae una hoja "Productos", una hoja "Receta" (ficha técnica) y una hoja "Ayuda" con las categorías y los
          insumos que ya tienes registrados en esta empresa.
        </p>
      </div>
